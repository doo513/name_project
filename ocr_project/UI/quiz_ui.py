...
class QuizWindow:
    ...
    def _build_ui(self) -> None:
        ...
        mode_frame = tk.Frame(self.win, padx=12, pady=4)
        mode_frame.pack(fill="x")
        tk.Label(mode_frame, text="문제 유형:").pack(side="left")
        tk.Radiobutton(
            mode_frame, text="주관식", variable=self.problem_mode,
            value="subjective", command=self._on_mode_change,
        ).pack(side="left", padx=(6, 0))
        tk.Radiobutton(
            mode_frame, text="객관식", variable=self.problem_mode,
            value="objective", command=self._on_mode_change,
        ).pack(side="left", padx=(6, 0))
        tk.Button(
        ...
        result_box = tk.LabelFrame(self.win, text="결과", padx=10, pady=8)
        ...
        self.status_label = tk.Label(self.win, text="", fg="#888888", padx=12)
